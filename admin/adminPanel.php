                        ...
                        <div class="card border-left-success shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Organization</div>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800" id="total"> Add New Organization </div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <table class="table">
                      <thead>
                        <tr>
                          ...
                          <th scope="col">Pattfile</th>
                          <th scope="col">Markerfile</th>
                          ...
                          while ($row = $result->fetch_assoc()) {
                              ...
                              ?>+
                                ...
                                <tr>
                                      ...
                                      <td> 
                                            <a href="<?php echo $pattfile; ?>" class="btn btn-success btn-block" download>Download</a> 
                                            <form action="upload-patt" method="POST" enctype="multipart/form-data" class="p-2">
                                                <input type="hidden" value="<?php echo $id; ?>" name="id">
                                                <input type="file" class="form-control mt-2 mb-2" name="fileToUpload" required>
                                                <input type="submit" class="btn btn-outline-success btn-block" value="Upload New">
                                            </form>
                                      </td>
                                      <td>  
                                          <a href="<?php echo $markerfile; ?>" class="btn btn-primary btn-block" download>Download</a> 
                                            <form action="upload-marker" method="POST" enctype="multipart/form-data" class="p-2">
                                                <input type="hidden" value="<?php echo $id; ?>" name="id">
                                                <input type="file" class="form-control mt-2 mb-2" name="fileToUpload" required>
                                                <input type="submit" class="btn btn-outline-success btn-block" value="Upload New">
                                            </form>
                                      </td>
                                      <td> <input type="button" class="btn btn-outline-danger" value="Delete" onclick="window.location='user-delete?id=<?php echo $id; ?> ' "> </td>
                                </tr>
                              <?php
                          }
                      } ?>
