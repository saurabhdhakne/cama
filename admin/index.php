                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800" id="total"> Add New User </div>
                                        </div>
                                        <div class="col-auto">
                          ...
                          while ($row = $result->fetch_assoc()) {
                              ...
                              ?>
                                ...
                                <tr>
                                      ...
                                      <td> <input type="button" class="btn btn-outline-primary" value="Edit" onclick="window.location='user-update?id=<?php echo $id; ?>' "> </td>
