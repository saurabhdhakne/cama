      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto col-12">
            ...
            <li class="nav-item dropdown no-arrow text-primary mx-1 d-flex align-items-center pointer col-md-10">
                ...
                <b>
                    Welcome <span class="text-secondary"> <?php echo $user_name; ?> </span>
                </b>
            </li>
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">AR LAB</h1>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800" id="total"> Add New Modal </div>
                                        </div>
                                        <div class="col-auto">
                          ...
                          while ($row = $result->fetch_assoc()) {
                              ...
                              ?>
                                ...
                                <tr>
                                      ...
                                      <td> <input type="button" class="btn btn-outline-success" value="Download" onclick="window.location='download-patt?id=<?php echo $user_orgid; ?>' "> </td>
                                      <td> <input type="button" class="btn btn-outline-primary" value="Open" onclick="window.location='arlab?id=<?php echo $id; ?>' "> </td>
                                      <td> <input type="button" class="btn btn-outline-danger" value="Delete" onclick="window.location='modal-delete?id=<?php echo $id; ?> ' "> </td>
                                </tr>
                              <?php
                          }
                      } ?>
